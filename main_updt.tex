...
Robinson et al. \citep{Robinson2018} emphasized shaking-induced impacts concentrated near rupture zones, providing valuable insights through scenario ensemble approaches. Building on this previous work, our study incorporates landslides as cascading hazards to expand the analysis. Overall, the correlation between the previous work align well at district level with a correlation of 0.78 (Figure \ref{fig:S5}) which is expected as the earthquake ensemble members are similar and represent a large part of the multi-hazard damage, as presented in the Result section. The multi-hazard scenarios reveal broader and more specific spatial impacts beyond zones affected by shaking, especially in steep, landslide-prone areas (Figure \ref{fig:worst_case_maps} and \ref{fig:standard_deviation}). Figure~\ref{fig:district_exceedance} shows that districts in the High Mountain and Hill physiographic regions experience higher exceedance probabilities of landslide impacts than shaking impacts alone.
